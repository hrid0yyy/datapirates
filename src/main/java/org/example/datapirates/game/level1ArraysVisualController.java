...
public class level1ArraysVisualController {
    ...
    @FXML
    void proceedToQuiz(ActionEvent event) {
        transition.backButtonClick(event, "/org/example/datapirates/game/level1ArraysTestQuizeHome.fxml");
    }
